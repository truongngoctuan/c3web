<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Nam.aspx.cs" Inherits="CTLH_C3.DieuHanhCongTy.SoLuongKhach.Nam" %>

<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
<h2>Thống kê số lượng khách/tuyến theo các năm</h2>
