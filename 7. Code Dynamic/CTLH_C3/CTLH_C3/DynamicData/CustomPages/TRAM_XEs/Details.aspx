<%@ Page Language="C#" MasterPageFile="~/DieuHanhCongTy/MasterPage.Master" CodeBehind="Details.aspx.cs" Inherits="CTLH_C3.TRAM_XEs.Details" %>
<%@ Register Src="~/Guest/user_CustomLogin.ascx" TagName="user_Login" TagPrefix="webUC" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="/dieuhanhcongtystyle.css" />
    <title>Xem Chi Tiết Một Trạm</title>
</asp:Content>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:DynamicDataManager ID="DynamicDataManager1" runat="server" AutoLoadForeignKeys="true" />

    <h1>Xem Chi Tiết Một Trạm</h1>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                    ...
                    <asp:TemplateField> 
                        <ItemTemplate> 
                               ...
                               <asp:Button ID="DeleteLinkButton" runat="server" CommandName="Delete" CausesValidation="false"
                                OnClientClick='return confirm("Bạn có chắc muốn xóa trạm xe này?");'
                                Text="Xóa" />
            ...
            <div class="bottomhyperlink">
                <asp:HyperLink ID="ListHyperLink" runat="server">Xem danh sách trạm</asp:HyperLink>
            </div>        
        </ContentTemplate>
    </asp:UpdatePanel>
    </div>
