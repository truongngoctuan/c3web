<%@ Page Language="C#" MasterPageFile="~/DieuHanhCongTy/MasterPage.Master" CodeBehind="List.aspx.cs" Inherits="CTLH_C3.NHAN_VIENs.List" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource"
                ...
                <EmptyDataTemplate>
                    Không có nhân viên nào trong cơ sở dữ liệu!
                </EmptyDataTemplate>
            </asp:GridView>
            ...
            <div class="bottomhyperlink">
                <asp:HyperLink ID="InsertHyperLink" runat="server"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Thêm nhân viên mới</asp:HyperLink>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
