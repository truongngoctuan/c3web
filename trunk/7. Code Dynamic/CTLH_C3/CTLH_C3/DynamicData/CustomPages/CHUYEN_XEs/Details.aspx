<%@ Page Language="C#" MasterPageFile="~/DieuHanhTram/MasterPage.Master" CodeBehind="Details.aspx.cs" Inherits="CTLH_C3.CHUYEN_XEs.Details" %>
<%@ Register Src="~/Guest/user_CustomLogin.ascx" TagName="user_Login" TagPrefix="webUC" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="/dieuhanhcongtystyle.css" />
    <title>Xem Thông Tin Chuyến</title>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:DynamicDataManager ID="DynamicDataManager1" runat="server" AutoLoadForeignKeys="true" />

    <h1>Xem Thông Tin Chuyến Xe</h1>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="bottomhyperlink">
                <asp:HyperLink ID="ListHyperLink" runat="server">Xem Danh Sách Chuyến</asp:HyperLink>
            </div>        
        </ContentTemplate>
    </asp:UpdatePanel>
    </div>
